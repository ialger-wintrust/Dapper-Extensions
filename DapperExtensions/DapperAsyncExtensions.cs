...
public static class DapperAsyncExtensions
{
    ...
    public static Task<T?> FindAsync<T>(this IDbConnection connection, object predicate, IDbTransaction? transaction = null, int? commandTimeout = null)
    {
        return Instance.FindAsync<T>(connection, predicate, transaction, commandTimeout);
    }
    ...
    {
        return await Instance.GetAsync<T>(connection, id, transaction, commandTimeout, includedProperties);
    }

    /// <summary>
    /// Executes a select query using the specified predicate, returning an IEnumerable data typed as per T.
    /// </summary>
    public static async Task<IEnumerable<T>?> ListAsync<T>(this IDbConnection connection, object? predicate = null,
        IList<ISort>? sort = null, IDbTransaction? transaction = null,
        int? commandTimeout = null, IList<IReferenceMap>? includedProperties = null)
    {
        return await Instance.ListAsync<T>(connection, predicate, sort, transaction, commandTimeout, includedProperties);
    }
    ...
    /// </summary>
    public static async Task<T> InsertAsync<T>(this IDbConnection connection, T entity,
        IDbTransaction? transaction = null, int? commandTimeout = null)
    {
    ...
    public static async Task<int> UpdateAsync<T>(this IDbConnection connection, T entity,
        IDbTransaction? transaction = null, int? commandTimeout = null,
        bool ignoreAllKeyProperties = false, IList<IProjection>? columnsToUpdate = null)
    {
        return await Instance.UpdateAsync(connection, entity, transaction, commandTimeout, ignoreAllKeyProperties, columnsToUpdate);
    }
    ...
    /// </summary>
    public static async Task<int> DeleteAsync<T>(this IDbConnection connection, object? predicate, IDbTransaction? transaction = null, int? commandTimeout = null)
    {
    ...
    /// </summary>
    public static async Task<IEnumerable<T>?> PageAsync<T>(this IDbConnection connection, object? predicate = null, IList<ISort>? sort = null, int page = 1,
        int resultsPerPage = 10, IDbTransaction? transaction = null, int? commandTimeout = null, bool buffered = false)
    {
        return await Instance.PageAsync<T>(connection, predicate, sort, page, resultsPerPage, transaction, commandTimeout, null);
    }

    public static async Task<IMultipleResultReader> GetMultipleAsync(this IDbConnection connection, GetMultiplePredicate predicate, IDbTransaction? transaction = null, int? commandTimeout = null, bool buffered = false)
    {
        return await Instance.GetMultipleAsync(connection, predicate, transaction, commandTimeout, null);
    }
    ...
    {
        return await Task.Run(() => Instance.LastExecutedCommand?.ToString());
    }
    ...
    //{
    //    var cols = GetBufferedCols<TOut>();
    //    TIn obj = await Instance.GetAsync<TIn>(connection, id, transaction, commandTimeout, buffered, cols);
    ...
    //{
    //    var cols = GetBufferedCols<TOut>();
    //    List<TIn> list = (await Instance.ListAsync<TIn>(connection, predicate, sort, transaction, commandTimeout, buffered, cols)).ToList();
    //    Func<TIn, TOut> f = func.Compile();
    ...
    //{
    //    return await Instance.GetListAutoMapAsync<T>(connection, predicate, sort, transaction, commandTimeout, buffered, colsToSelect);
    //}

    ///// <summary>
    ///// Executes an insert query for the specified entity.
    ///// </summary>
    //public static async Task InsertAsync<T>(this IDbConnection connection, IEnumerable<T> entities, IDbTransaction? transaction = null, int? commandTimeout = default)
    //{
    //    return await Instance.InsertAsync(connection, entities, transaction, commandTimeout);
    //}
    ...
    //    List<TIn> list = (await Instance.PageAsync<TIn>(connection, predicate, sort, page, resultsPerPage, transaction, commandTimeout, buffered, null)).ToList();
    ...
    //{
    //    return await Instance.GetPageAutoMapAsync<T>(connection, predicate, sort, page, resultsPerPage, transaction, commandTimeout, buffered, colsToSelect);
    //}
    ...
    //{
    //    return await Instance.GetSetAsync<T>(connection, predicate, sort, firstResult, maxResults, transaction, commandTimeout, buffered, null);
    //}
